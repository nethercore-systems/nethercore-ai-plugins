...
| Agent | When to Use |
|-------|-------------|
| `nethercore-zx-procgen:asset-generator` | To regenerate with modified parameters |
| `nethercore-zx-procgen:quality-analyzer` | To assess quality before/after |
| `nethercore-zx-procgen:asset-critic` | To validate SADL spec compliance |
