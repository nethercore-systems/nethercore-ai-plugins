...
Reusable patterns for common body parts. Copy and modify for your character's `.spec.py` file.
...
"head": {
    ...
    "steps": [
        ...
        {"extrude": 0.04, "scale": [1.1, 1.15], "translate": [0, 0.02, 0]},

        # FACE - flatten front, rounder back
        {"extrude": 0.06, "scale": [1.15, 1.0], "translate": [0, 0.015, 0]},

        # BROW
        {"extrude": 0.03, "scale": [1.05, 1.1], "translate": [0, 0.01, 0]},

        # FOREHEAD - recede slightly
        {"extrude": 0.04, "scale": [1.0, 0.95], "translate": [0, -0.01, 0]},
...
"foot_L": {
    ...
    "steps": [
        ...
        # Heel - push backward
        {"extrude": 0.025, "scale": [1.0, 1.3], "translate": [0, -0.02, 0]},

        # Sole - flatten and extend forward
        {"extrude": 0.015, "scale": [1.1, 0.8], "translate": [0, 0.04, 0]},

        # Toe box
        {"extrude": 0.04, "scale": [0.9, 0.9], "translate": [0, 0.02, 0]},
