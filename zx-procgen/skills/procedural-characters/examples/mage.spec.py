...
SPEC = {
    "character": {
        ...
        "skeleton": [
            ...
            {"bone": "arm_upper_L", "parent": "spine", "head": [-0.12, 0, 1.22], "tail": [-0.28, 0, 1.12]},
            {"bone": "arm_lower_L", "parent": "arm_upper_L", "head": [-0.28, 0, 1.12], "tail": [-0.45, 0, 1.0]},
        ...
        "parts": {
            ...
            "head": {
                ...
                "steps": [
                    ...
                    # Face
                    {"extrude": 0.04, "scale": [1.1, 1.15], "translate": [0, 0.015, 0]},  # chin forward
                    {"extrude": 0.05, "scale": [1.15, 1.0]},

                    # Brow
                    {"extrude": 0.03, "scale": [1.05, 1.05]},
