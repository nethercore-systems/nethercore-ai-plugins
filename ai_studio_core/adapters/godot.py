...
def export_from_report(*, report_path: Path, dest_root: Path) -> Path:
    """
    Minimal adapter: copies validated outputs into a Godot-friendly folder layout and
    writes a small manifest JSON. Does not require Godot installed.
    """
    ...
    manifest_path = dest_root / "ai_studio_godot_manifest.json"
