# nethercore — Skills & Agents Index
...
| [debugging](skills/debugging/SKILL.md) | F4 inspector, live edit, frame stepping | 1 |

## Agents

| Name | Model | Purpose |
|------|-------|---------|
| [build-analyzer](agents/build-analyzer.md) | haiku | ROM size analysis + optimization suggestions |
| [replay-debugger](agents/replay-debugger.md) | sonnet | Replay-based debugging and root cause analysis |
