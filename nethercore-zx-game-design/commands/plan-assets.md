...
Extract asset requirements from a Game Design Document and generate specifications compatible with the nethercore-zx-procgen plugin.
...
Assets ready for nethercore-zx-procgen:
...
**For Procgen Assets:**
- Suggest using `/generate-asset` from nethercore-zx-procgen
