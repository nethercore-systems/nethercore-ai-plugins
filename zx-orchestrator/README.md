...
{
  "plugins": {
    "zx-orchestrator@nethercore-ai-plugins": {
      "enabled": true
    }
  }
}
...
| `zx-game-design` | GDD, constraints, multiplayer |
| `zx-procgen` | Procedural asset generation |
| `zx-dev` | Project scaffolding, FFI |
| `zx-test` | Sync testing, regression |
| `zx-optimize` | Build analysis, optimization |
| `zx-publish` | Marketing assets, ROM packaging |
| `zx-cicd` | GitHub Actions, quality gates |
