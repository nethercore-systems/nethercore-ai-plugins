...
Not covered. Critical for game quality but no guidance exists.
...
- Gap 13 (Billboard Particles) for 3D particle implementation
- Gap 17 (Camera) for screen shake via camera
